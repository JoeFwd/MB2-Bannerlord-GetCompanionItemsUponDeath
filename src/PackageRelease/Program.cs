    ...
    private static void Main() {
        ...
        using (var proc = new Process()) {
            proc.StartInfo = new ProcessStartInfo {
                FileName = "git",
                Arguments = "archive --prefix=GetCompanionItemsUponDeath/ -o GetCompanionItemsUponDeath.zip -9 HEAD",
        ...
        using var fs = File.Open("GetCompanionItemsUponDeath.zip", FileMode.Open);
        ...
        foreach (var filePath in Directory.EnumerateFiles(dir)) {
            ...
            var ze = za.CreateEntry("GetCompanionItemsUponDeath/bin/Win64_Shipping_Client/" + fi.Name, CompressionLevel.Optimal);
